...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nombre) || empty($descripcion) || $precio <= 0 || $stock < 0) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            header("refresh:2;url=index.php?msg=updated");
        } else {
    ...
    <div class="admin-container">
        ...
        <main class="main-content">
            <header class="top-header">
                <h1>Editar Producto #<?php echo str_pad($id, 3, '0', STR_PAD_LEFT); ?></h1>
                <div class="user-info">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="categoria" name="categoria" required>
                                ...
                                <option value="camas" <?php echo $producto['categoria'] == 'camas' ? 'selected' : ''; ?>>Camas</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="precio" name="precio" step="0.01" required 
                                   value="<?php echo $producto['precio']; ?>" min="0">
                        </div>
                    </div>
